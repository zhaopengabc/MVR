...
HI_S32 SAMPLE_COMM_VDA_MdPrtObj(FILE *fp, VDA_DATA_S *pstVdaData)
{
   ...
   // HI_S32 i;
    ...
    for (HI_U32 i=0; i<pstVdaData->unData.stMdData.stObjData.u32ObjNum; i++)
    {
...
HI_S32 SAMPLE_COMM_VDA_OdPrt(FILE *fp, VDA_DATA_S *pstVdaData)
{
    ...
    for(HI_U32 i=0; i<pstVdaData->unData.stOdData.u32RgnNum; i++)
    {
